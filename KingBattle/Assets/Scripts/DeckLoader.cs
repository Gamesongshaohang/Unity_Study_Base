...
namespace UnityRoyale
{
    public class DeckLoader : MonoBehaviour
    {
        ...
        public void LoadDeck(DeckData deckToLoad)
        {
			...
			Addressables.LoadAssets<CardData>(targetDeck.labelsToInclude[0].labelString, null).Completed += OnCompleted;
        }

        private void OnCompleted(AsyncOperationHandle<IList<CardData>> obj)
        {
